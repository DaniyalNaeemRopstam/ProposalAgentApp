...
export const DEMO_ANALYTICS_MONTHLY = [
...
export const DEMO_ANALYTICS_PLATFORMS = [
...
export const DEMO_PIPELINE_DEALS: DemoPipelineDeal[] = [
  {
    _id: "demo-deal-1",
    isDemo: true,
  ...
  },
  {
    ...
    platform: "Freelancer",
    stage: "won",
    notes: "Signed — kickoff next week",
  },
];

export function demoPipelineGrouped(): Record<
...
> {
  ...
  for (const d of DEMO_PIPELINE_DEALS) {
    grouped[d.stage].push(d);
  }
  return grouped;
}

export const DEMO_PIPELINE_TOTAL_VALUE = 40500;
